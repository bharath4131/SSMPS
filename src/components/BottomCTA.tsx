...
export default function BottomCTA({ onOpenQuote }: BottomCTAProps) {
  ...
  return (
    <section className="relative py-24 md:py-32 bg-[#081B33] text-white text-center overflow-hidden border-b border-white/5">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#C41E3A]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <button
            onClick={onOpenQuote}
            className="px-8 py-4 bg-[#C41E3A] hover:bg-[#AA771C] text-[#081B33] font-bold text-xs tracking-wider uppercase rounded shadow-lg shadow-[#C41E3A]/15 transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer border border-[#C41E3A]"
          >
